...
public class TabulatedOperationService {
    ...
    public TabulatedFunction apply(String operation, TabulatedFunctionOperationService service, TabulatedFunction op1, TabulatedFunction op2) throws NoSuchOperationException{
        try {
