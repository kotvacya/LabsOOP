    ...
    return (
        <fieldset className={styles.form}>
            ...
            <div className={styles.container}>
                ...
                <VerifiedInput value={functionConfig.config.start} setValue={(val) => dispatch(setStart(val))} getError={(text, firstTime) => floatVerifier(text, firstTime, (val) => dispatch(setStart(val)))}/>
                <p className={styles.property}>Конец области</p>
                <VerifiedInput value={functionConfig.config.end} setValue={(val) => dispatch(setEnd(val))} getError={(text, firstTime) => floatVerifier(text, firstTime, (val) => dispatch(setEnd(val)))}/>
