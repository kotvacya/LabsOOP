...
public class LeftSteppingDifferentialOperatorTest extends TestCase {

    public void testDerive() {
        MathFunction sqr = new SqrFunction();
        MathFunction ct = new ConstantFunction(52.);

        LeftSteppingDifferentialOperator ls_do = new LeftSteppingDifferentialOperator(1e-6);
    ...
    public LeftSteppingDifferentialOperatorTest(String testName) {
        super(testName);
    }

    public static junit.framework.Test suite() {
        return new TestSuite(LeftSteppingDifferentialOperatorTest.class);
    }
